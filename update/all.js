...
async.series([
  ...
  /*function(done){
    async.eachSeries(articleList, function(c, next){
      read.articleDetail(c.url, function(err, list){
        articleDetail = list;
        //console.log(list.length);
        rowinfo.url = articleDetail.url;
        rowinfo.content = articleDetail.content;
        save.insert("bloginfo", rowinfo, function(err){
